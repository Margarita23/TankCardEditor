        ...
        blocks.forEach(block => {
            switch(block){
                case "0":
                    ...
                    img1.onload = () => {
                        this.ctx.drawImage(img1, this.canvas.width - this.maxBrushSize, Number(block) *  this.maxBrushSize * 2, this.maxBrushSize, this.maxBrushSize);
                    };
                    break;
                case "1":
                    let img2 = new Image();
                    ...
                    img2.onload = () => {
                        this.ctx.drawImage(img2, this.canvas.width - this.maxBrushSize, Number(block) *  this.maxBrushSize * 2, this.maxBrushSize, this.maxBrushSize);
                    };
                    break;
                case "2":
                    let img3 = new Image();
                    ...
                    img3.onload = () => {
                        this.ctx.drawImage(img3, this.canvas.width - this.maxBrushSize, Number(block) *  this.maxBrushSize * 2, this.maxBrushSize, this.maxBrushSize);
                    };
                    break;
                case "3":
                    let img4 = new Image();
                    ...
                    img4.onload = () => {
                        this.ctx.drawImage(img4, this.canvas.width - this.maxBrushSize, Number(block) *  this.maxBrushSize * 2, this.maxBrushSize, this.maxBrushSize);
                    };
                    break;
                case "4":
                    let img5 = new Image();
                    ...
                    img5.onload = () => {
                        this.ctx.drawImage(img5, this.canvas.width - this.maxBrushSize, Number(block) *  this.maxBrushSize * 2, this.maxBrushSize, this.maxBrushSize);
                    };
                    break;
            }
        });
